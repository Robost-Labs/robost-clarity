<h1 align="center">Robost Clarity</h1>
...
```bash
git clone https://github.com/robostai/robost-clarity.git
cd robost-clarity
docker-compose up -d
```
...
Robost Clarity consumes LLM traffic data from Kafka topics that are fed from network routers. Configure your Kafka connection in **Settings -> Data Sources** within the Robost interface. In the future we'll add more data sources.
...
**Made with care by the Robost Team**

[Star this project](https://github.com/robostai/robost-clarity) | [Report Bug](https://github.com/robostai/robost-clarity/issues) | [Request Feature](https://github.com/robostai/robost-clarity/discussions)
