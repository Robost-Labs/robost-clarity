# Robost Clarity - Installation Guide
...
### Kafka Integration
Robost Clarity is designed to consume LLM traffic data from Kafka topics. This data is typically fed from network routers that intercept and forward LLM API traffic.
...
**Note**: Your network router must be configured to publish LLM traffic data to a Kafka topic in JSON format for Robost Clarity to process.
...
**Congratulations! Your Robost Clarity detection server is now running.**
